...
public class KinectManager : MonoBehaviour
{
    ...
    public Vector3 getProfundidadArticulacion(Vector3 posJoint)
    {
        return KinectWrapper.MapSkeletonPointToDepthPoint(posJoint);
    }
    ...
    void OnGUI()
    {
        if (KinectInitialized)
        {
            if (ComputeUserMap && (/**(allUsers.Count == 0) ||*/ DisplayUserMap))
            {
                ...
                GUI.DrawTexture(cameraRect, usersLblTex);
            }
